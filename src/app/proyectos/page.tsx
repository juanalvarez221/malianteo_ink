        ...
        {["Todas", "Realismo", "Blackwork", "Surrealismo", "Fineline"].map(
          (t, i) => (
            <button
              ...
              className={
                i === 0
                  ? "shrink-0 rounded-full border border-violet-500/30 bg-violet-600/15 px-3 py-1 text-xs font-semibold text-violet-100"
          ...
          >
            <Card className="group overflow-hidden">
              <div className="relative aspect-square">
                ...
                <div className="absolute inset-0 bg-[radial-gradient(180px_180px_at_30%_20%,rgba(139,92,246,0.3),transparent_58%)]" />
                ...
                <div className="absolute inset-x-0 bottom-0 p-3">
                  <div className="rounded-2xl border border-white/10 bg-black/55 p-3 backdrop-blur">
                    ...
                    <div className="mt-2 flex items-center justify-between gap-2">
                      ...
                      <span className="h-1 w-10 rounded-full bg-violet-600/60 transition-all group-hover:w-16" />
                    </div>
                  </div>
                </div>
              </div>
